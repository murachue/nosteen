...
type Tabstate = {
    ...
    view: { scrollTop: number; clientHeight: number; rowHeight: number; } | null;
...
export const newtabstate: () => Tabstate = () => ({ selected: { id: null, index: null }, view: null, scroll: { top: 0, last: true }, replypath: [] });
